...
const winnersData = [
  {
    ...
    prize: "₹50,000",
    position: "1st Place",
    description: "Revolutionary AI-powered diagnostic tool that helps doctors identify diseases faster and more accurately."
  },
  {
    title: "EcoChain",
    team: "Green Coders", 
    ...
    prize: "₹30,000",
    position: "2nd Place",
    description: "Blockchain-based carbon credit marketplace enabling transparent environmental impact tracking."
  },
  {
    title: "SafeRide",
    ...
    prize: "₹20,000",
    position: "3rd Place",
    description: "Smart transportation app with real-time safety features and emergency response integration."
  }
];
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Celebrating the brilliant minds who turned ideas into reality and claimed victory at CODECRATZ 2024.
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
          {winnersData.map((winner, index) => (
            <Card key={index} className="card-gradient border-0 group hover:scale-105 transition-transform duration-300">
              <CardContent className="p-6">
                ...
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="text-sm font-medium text-foreground">{winner.team}</span>
                </div>
                ...
                <div className="flex items-center justify-center">
                  <div className="flex items-center gap-2 bg-gradient-to-r from-primary/10 to-accent/10 px-4 py-2 rounded-full">
                    ...
                    <span className="text-sm font-bold text-foreground">{winner.prize}</span>
                  </div>
                </div>
              </CardContent>
            </Card>
        ...
        <div className="text-center mt-12">
          <div className="card-gradient rounded-2xl p-8 max-w-2xl mx-auto">
            <h3 className="text-2xl font-bold mb-4 text-foreground">Ready to Join Them?</h3>
            <p className="text-muted-foreground mb-6">
              Your innovative idea could be the next big winner. Register for CODECRATZ '25 and compete for glory!
            </p>
            <button 
