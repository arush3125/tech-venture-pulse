      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <Card className="card-gradient text-center group">
            <CardContent className="p-8">
              ...
              <p className="muted-text">Intensive coding marathon to build innovative solutions</p>
            </CardContent>
          </Card>
          ...
          <Card className="card-gradient text-center group">
            <CardContent className="p-8">
              ...
              <p className="muted-text">Solve actual challenges faced by industries and society</p>
            </CardContent>
          </Card>
          ...
          <Card className="card-gradient text-center group">
            <CardContent className="p-8">
              ...
              <p className="muted-text">Collaborate with fellow students and learn together</p>
            </CardContent>
          </Card>
          ...
          <Card className="card-gradient text-center group">
            <CardContent className="p-8">
              ...
              <p className="muted-text">Compete for exciting prizes and recognition</p>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="max-w-4xl mx-auto">
          <Card className="card-gradient">
            <CardContent className="p-8">
              <h3 className="text-2xl font-bold mb-6 text-center">Event Objectives</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <h4 className="text-lg font-semibold mb-3">Innovation & Creativity</h4>
                ...
                <div>
                  <h4 className="text-lg font-semibold mb-3">Skill Development</h4>
                  <p className="body-text">
